...
PostsListController = RouteController.extend({
    ...
    findOptions: function () {
        console.log(JSON.parse(JSON.stringify({sort: this.sort, limit: this.postsLimit()})));
    ...
    data: function () {
        ...
        /*
         ...
         console.log(JSON.parse(JSON.stringify(nextPath)));
         console.log('this.nextpath:')
         console.log(JSON.parse(JSON.stringify(this.nextPath)));
         */
